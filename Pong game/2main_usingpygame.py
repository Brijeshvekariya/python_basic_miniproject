...
while running:
    ...
    if ball.left <= 0 or ball.right >= WIDTH:
        ...
        pygame.draw.rect(screen, (WHITE),game_over_rect)  # Button color
        game_over_surface = font.render(f"GAME-OVER",True,(255,255,255))
        # ball_dx *= random.choice((1, -1))
        screen.blit(game_over_surface,(330,310))
    ...
    if reset_button:
        ...
        screen.blit(reset_button_text, (365, 400))  # Position the text

    # Display current score
    score_surface = font.render(f"Score : {score}", True, (255,255,255))
    screen.blit(score_surface, (10, 30))

    highscore_surface = font.render(f"High Score: {highscore}", True, (255,255,255))
    screen.blit(highscore_surface, (10, 70))
